...
Наша компания выполняет укладку плитки и ремонты санузлов *под ключ* в Тюмени по заказам от Лемана Про (Леруа Мерлен).
...
• Работа по договору
• Спецодежда — выдаётся
• Инструмент — желательно свой (можем доукомплектовать, есть в наличии)
